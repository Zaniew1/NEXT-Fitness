...
export type CustomButtonType = {text: string, icon?: "tel" | "mes", path: string, color: "white" | "black"};
export const CustomButton:React.FC<CustomButtonType> = (props): JSX.Element => {

  return (
    <Link className={styles.button} href={props.path} style={{color:`${props.color}`, borderColor:`${props.color}`}}>
            <div className={styles.button__wrapper} style={{color:`${props.color}`}} >
