    ...
    return(
        <section className={classes.about}>
          <div className={classes.about__header}>
              ...
              <motion.div initial={{opacity: 0, x:-200, y: 300 }} whileInView={{ opacity:100, x: 0, y: 0}}  className={classes.about__image}>
                    <CustomImage src={'/klaudia.jpg'} alt={'Obraz przedstawiający Klaudię Schmidt'} priority={false} quality={90}/>
              </motion.div>
              <motion.div  transition={{delay:0.6}}  initial={{opacity: 0, x:200}} whileInView={{ opacity:100, x:0}} className={classes.about__text}>
