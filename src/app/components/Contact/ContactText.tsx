...
export const ContactText: React.FC = (): JSX.Element =>{
    ...
    return (
        <div className={classes.contact__text } >
            ...
            <motion.p viewport={{ once: true }} initial={{x: -200, opacity: 0}} whileInView={{x:0, opacity: 1}} className={classes.contact__text__paragraph }>Na wiadomości mailowe / FB / Instagram / smsy odpowiadam w przeciągu 24 godzin.</motion.p>
